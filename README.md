...
sudo pacman -S polybar rofi ranger alacritty conky system-config-printer
```
...
sudo pacman -S chromium telegram-desktop fontforge gparted obs-studio \
               ...
               shotwell file-roller shotcut inkscape evolution mousepad spotify-launcher
```
...
sudo pacman -S neovim stow sqlite3 tldr jq tmux openvpn \
               ...
               pgcli redis plantuml ripgrep gitui
